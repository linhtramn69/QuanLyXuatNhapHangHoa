        ...
        <>
            <SidebarMenu>
                <SidebarMenu.Body>
                    ...
                    <Link to="/staff/import-manager" className='text-black text-decoration-none'>
                        <SidebarMenu.Nav>
                            <SidebarMenu.Nav.Icon>
                                {' '}
                    ...
                    <Link to="/staff/product-manager" className='text-black text-decoration-none'>
                        <SidebarMenu.Nav>
                            <SidebarMenu.Nav.Icon>
                    ...
                    <Link to="/staff/type-product-manager" className='text-black text-decoration-none'>
                        <SidebarMenu.Nav>
                            <SidebarMenu.Nav.Icon>
                    ...
                    <Link to="/staff/brand-manager" className='text-black text-decoration-none'>
                        <SidebarMenu.Nav>
                            <SidebarMenu.Nav.Icon>
                                <FontAwesomeIcon className={cx('icon-user')} icon={faBox} />
                            </SidebarMenu.Nav.Icon>
                    ...
                    <Link to="/staff/kho-manager" className='text-black text-decoration-none'>
                        <SidebarMenu.Nav>
                            <SidebarMenu.Nav.Icon>
                                <FontAwesomeIcon className={cx('icon-user')} icon={faBox} />
                            </SidebarMenu.Nav.Icon>
